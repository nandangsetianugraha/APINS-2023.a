...
$output = array('data' => array());
	...
	while ($row = $query->fetch_assoc()) {
		...
		$actionButton = '
		<div class="btn-group">
			<a href="'.base_url().'peserta-didik/'.$idp.'" type="button" class="mb-1 mt-1 me-1 btn btn-sm btn-default" data-smt="'.$smt.'" data-tapel="'.$tapel.'" data-siswa="'.$idp.'"><i class="far fa-address-card"></i></a>
		</div>
		<div class="btn-group">
		...
		$output['data'][] = array(
			...
			$row['tempat'].'<br/>'.TanggalIndo($tgllahir),
			$actionButton
		);
	}
