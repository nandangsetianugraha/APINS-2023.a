								...
								<div class="portlet-header portlet-header-bordered">
									<div class="avatar avatar-circle avatar-lg">
										<div class="avatar-display">
											<img src="images/siswa/<?=$infoptk['avatar'];?>" alt="AI">
										</div>
									</div>
									<div class="portlet-addon">
										...
										<div class="nav nav-lines portlet-nav" id="portlet4-tab">
											...
											<a class="nav-item nav-link" id="portlet4-contact-tab" data-bs-toggle="tab" href="#portlet4-contact">Contact</a>
										</div>
										<!-- END Nav -->
									</div>
								</div>
								<div class="portlet-body">
									...
									<div class="tab-content">
										...
										<div class="tab-pane fade" id="portlet4-contact">
											<p class="mb-0">Tahap Pengembangan</p>
										</div>
									</div>
									<!-- END Tab -->
								</div>
