		...
		<div class="content">
			<div class="page-header">
				<div class="page-title">
					<h4>Wikipedia</h4>
					<h6><a href="add-wiki" class="btn btn-primary">
								Buat Wikipedia
							  </a></h6>
				</div>
			</div>
			<div class="card">
				<div class="card-body">
					<?php 
							...
							$jbrt1=$connect->query("select * from wiki order by id desc")->num_rows;
							if($jbrt1>0){
							?>
							<div class="table-responsive">
								<table class="table table-sm table-striped" id="table-1">
									...
									<tr>
										...
										<td></td>
										<td><a href="<?=base_url();?>edit-wiki/<?=$pg1['id'];?>">Edit</a><a href="#" class="text-danger" data-bs-toggle="modal" data-bs-target="#hapusberitaModal" onclick="hapusBerita('5')">Trash</a>										
										</td>
									</tr>
									<?php } ?>
									</tbody>
