	...
	<div class="page-wrapper pagehead">
		<div class="content">
			...
			<div class="card">
				<div class="card-body">
					<div class="row">
						<form class="p-3" action="modul/berita/simpan-wiki.php" method="POST">
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="hidden" name="penulis" value="<?=$bioku['ptk_id'];?>">
								</div>
							</div>
						</div>
						...
						<div class="col-lg-12 col-sm-12 col-12">
							<div class="form-group">
								...
								<textarea name="content" id="konten"></textarea>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-12">
