	...
	<div class="page-wrapper pagehead">
		...
		?>
			<div class="page-header">
				...
				<div class="page-btn">
					<a href="tambah-siswa-baru" type="button" class="btn rounded-0 btn-primary mb-2" aria-label="Close">Tambah Siswa Baru</a>
				</div>
			</div>
			<div class="card">
				<div class="card-body">
					...
					<input type="hidden" name="stst" id="stst" class="form-control" value="99" placeholder="Username">
...
<script src="<?=base_url();?>ajax/siswa-baru.js"></script>
